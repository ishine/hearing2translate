SAVING_BASE_DIR="./output_evals/libristutter"

# ref_free_only
# --- Configuration ---
# Define systems and pairs. The pairs use the primary format (with a hyphen)
SYSTEMS=('qwen2audio-7b' 'phi4multimodal' 'desta2-8b' 'voxtral-small-24b' 'owsm4.0-ctc' 'canary-v2' 'seamlessm4t' 'gemma_whisper' 'gemma_seamlessm4t' 'gemma_canary-v2')
DIRECTION_PAIRS=('en-fr' 'en-it' 'en-nl' 'en-pt' 'en-de' 'en-es' 'en-zh')
...
for system in "${SYSTEMS[@]}"; do
    ...
    for pair in "${DIRECTION_PAIRS[@]}"; do
        ...
        MANIFEST="${BASE_PATH}/manifests/libristutter/${pair}.jsonl"
        OUTPUT_JSONL="${BASE_PATH}/outputs/${system}/libristutter/${pair}.jsonl"

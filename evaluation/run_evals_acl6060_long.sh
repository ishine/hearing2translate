...
for system in "${SYSTEMS[@]}"; do
    ...
    for pair in "${DIRECTION_PAIRS[@]}"; do
        ...
        MANIFEST_SHORT="${BASE_PATH}/manifests/acl6060-short/${pair}.jsonl"
        MANIFEST_LONG="${BASE_PATH}/manifests/acl6060-long/${pair}.jsonl"

        OUTPUT_JSONL="${BASE_PATH}/outputs/${system}/acl6060-long/${pair}.jsonl"
        OUTPUT_SEGMENTED_JSONL="${BASE_PATH}/outputs/${system}/acl6060-long/${pair}_segmented.jsonl"

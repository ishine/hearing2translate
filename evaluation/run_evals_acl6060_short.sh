...
SYSTEMS=('qwen2audio-7b' 'phi4multimodal' 'desta2-8b' 'canary-v2' 'seamlessm4t' 'voxtral-small-24b' 'spirelm' 'owsm4.0-ctc')
DIRECTION_PAIRS=('en-de' 'en-fr' 'en-pt' 'en-zh')

# Define constant base paths.
EVAL_MODE="ref_free_and_ref_based"
SAVING_BASE_DIR="./output_evals/acl6060-short"
...
for system in "${SYSTEMS[@]}"; do
    ...
    for pair in "${DIRECTION_PAIRS[@]}"; do
        ...
        MANIFEST="${BASE_PATH}/manifests/acl6060-short/${pair}.jsonl"
        OUTPUT_JSONL="${BASE_PATH}/outputs/${system}/acl6060-short/${pair}.jsonl"
